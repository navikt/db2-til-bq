...
tables = [
    {
        "name": "t_faggruppe",
        "query":f"select KODE_FAGGRUPPE, NAVN_FAGGRUPPE from {schema}.t_faggruppe"
    },
    {
        "name": "t_fagomraade",
        "query":f"select KODE_FAGOMRAADE ,NAVN_FAGOMRAADE,KODE_FAGGRUPPE from {schema}.t_fagomraade"
    },
    {
        "name": "t_vent_beregning",
        "query":f"select Beregnings_id, dato_beregnet, kode_faggruppe from {schema}.t_vent_beregning"
    },
    {
        ...
        "query":f"""
                ...
                from {schema}.T_VENT_STOPPNIVAA /* antall beregninger, per fagområde */
                """
    },
    {
        ...
        "query":f"""
                ...
                from {schema}.T_VENT_STOPPSTATUS /* oversikt over beregningsflyten og identifisere eventuelle flaskehalser */
                """
    },
    {
        ...
        "query":f"""
                ...
                from {schema}.T_VENT_STATUSKODE /* betydning av ventestatuskoden */
                """
    },
]
